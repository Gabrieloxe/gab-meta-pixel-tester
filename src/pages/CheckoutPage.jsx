            ...
            <form onSubmit={handleInfoSubmit} className="card bg-base-200 border border-base-300">
              <div className="card-body gap-4">
                ...
                <fieldset className="fieldset w-full">
                  ...
                  <input
                    required
                    className="input w-full border border-base-300 focus:outline-none focus:border-primary"
            ...
            <form onSubmit={handlePaymentSubmit} className="card bg-base-200 border border-base-300">
              <div className="card-body gap-4">
                ...
                <fieldset className="fieldset w-full">
                  ...
                  <input
                    required
                    className="input w-full font-mono border border-base-300 focus:outline-none focus:border-primary"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <fieldset className="fieldset">
                    ...
                    <input
                      required
                      className="input font-mono border border-base-300 focus:outline-none focus:border-primary"
                      placeholder="MM/YY"
                      maxLength={5}
                    />
                  </fieldset>
                ...
                <p className="text-xs text-center text-base-content/40">
                  Fires <code className="bg-base-300 px-1 rounded">AddPaymentInfo</code> +{' '}
                  <code className="bg-base-300 px-1 rounded">Purchase</code> on submit
                </p>
              </div>
            </form>
          )}
